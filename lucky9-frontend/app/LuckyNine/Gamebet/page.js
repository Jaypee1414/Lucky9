...
const Page = () => {
  ...
  return (
    <div className="h-screen w-full bg-bet-background">
      ...
      <main>
        <div className="w-full h-full p-20 flex justify-center items-center flex-col gap-5 space-y-5">
          {/* text */}
          ...
          <div className="flex flex-row w-[1000px] justify-center items-end ">
            <Image
              onClick={() => {handleClick(0); setBet(100000)}}
              src="/image/bet1.svg"
              width={40}
              height={45}
              alt="3 star bet"
            ...
            <Image
              onClick={() => {handleClick(1); setBet(50000) }}
              src="/image/bet2.svg"
              width={40}
              height={45}
              alt="3 star bet"
            ...
            <Image
              onClick={() => {handleClick(2); setBet(25000)}}
              src="/image/bet3.svg"
              width={40}
              height={45}
              alt="3 star bet"
            ...
            <Image
              onClick={() => {handleClick(3); setBet(20000) }}
              src="/image/bet4.svg"
              width={40}
              height={45}
              alt="3 star bet"
            ...
            <Image
              onClick={() => {handleClick(4); setBet(15000)}}
              src="/image/bet5.svg"
              width={40}
              height={45}
              alt="3 star bet"
            ...
            <Image
              onClick={() => {handleClick(5); setBet(10000)}}
              src="/image/bet6.svg"
              width={40}
              height={45}
              alt="3 star bet"
          ...
          {/* button quickplay */}
          <div className="flex gap-2 flex-row w-[1000px] justify-center items-end">
            <Image
              ...
              className="h-14 w-full z-10 animate-pulse cursor-pointer"
            />
          </div>
        </div>
      </main>
